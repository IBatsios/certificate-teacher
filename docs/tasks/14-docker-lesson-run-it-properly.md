...
**Status:** built on `feature/docker-lesson-run`, pull request #28 open with CI green.
...
- [x] Every earlier test still passes locally: 243 unit tests and 49 Playwright journeys (48 plus the new one) on 2026-09-13. CI green on pull request #28 (both jobs, on the feature commit and on the docs commit).
